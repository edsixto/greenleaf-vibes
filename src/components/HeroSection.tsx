              ...
              <CardContent className="p-4 sm:p-6">
                ...
                <div className="mt-4">
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center w-full bg-vegan-600 hover:bg-vegan-700 text-white font-bold py-2 px-4 rounded-md transition-colors shadow-md"
                  >
